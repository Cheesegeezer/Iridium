...
namespace Iridium.Fonts
{
    public class FontManager
    {
        ...
        private bool AreFontsAccessible()
        {
            ...
            {
                Logger.ReportInfo("The Required Iridium Fonts are installed.");
                return true;
            }
            Logger.ReportError("The Required Iridium Fonts are not installed / not accessible.");
            return false;
        }
